"""Basic incompatible-twist sanity check; no transfer-matrix enumeration.

Parameters:
    q=4=2^2, K=F_4, n=5, lambda=omega, k=0 (Euclidean).

Here sigma=p^k=1 and rho=p^(e*m-k)=4, and both induce the identity on
F_4. Therefore this test is DIAGNOSTIC ONLY and is not a convention-
resolution test. The N2-B extension-field diagnostic performs that test.
...
def main():
    ...
    print("  sigma == rho as automorphisms on F_4: True")
