...
Here the principal exponent is p^k=2 and lambda^(1+p^k)=omega^3=1.  The polynomial
...
def main():
    ...
    for factor in FACTORS:
        image = normalized_galois_reciprocal(F, factor, SIGMA)
    ...
    print("  q=4, n=5, lambda=omega != 1, k=1, p^k=2")
